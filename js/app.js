 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function swiperSmall() {
            if (document.querySelector(".authors__slider")) if (window.innerWidth <= 768) {
                if (!init) {
                    init = true;
                    sliderAuthors = new core(".authors__slider", {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
                        ...
                        loop: false,
                        navigation: {
                            prevEl: ".authors__button_prev",
                            nextEl: ".authors__button_next"
                        },
                        on: {}
                    });
                }
            } else if (init) {
                sliderAuthors.destroy();
                init = false;
            }
            if (document.querySelector(".slider-latest")) if (window.innerWidth <= 767.98) {
                if (!init) {
                    init = true;
                    sliderLatest = new core(".slider-latest", {
                        modules: [ Navigation ],
                        slidesPerView: 1,
                        spaceBetween: 40,
                        autoHeight: false,
                        speed: 800,
                        navigation: {
                            prevEl: ".navigation-slider__button_prev",
                            nextEl: ".navigation-slider__button_next"
                        }
                    });
                }
            } else if (init) {
                sliderLatest.destroy(true, true);
                init = false;
            }
        }
        swiperSmall();
        window.addEventListener("resize", swiperSmall);
        ...
        window.addEventListener("load", isotope_windowLoad);
        function isotope_windowLoad() {
            const buttons = document.querySelector(".catalog-magazine__buttons");
            ...
            document.querySelectorAll(".catalog-magazine__category").forEach((el => {
